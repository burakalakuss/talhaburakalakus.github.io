...
excerpt: 'This study proposes a novel deep learning approach based on Neural Circuit Policy (NCP) for forecasting the Standardized Precipitation Index (SPI) at multiple time scales. The model is evaluated on a drought-prone basin in Türkiye and compared with traditional machine learning and deep learning methods.'
date: 2026-02-12
venue: 'Applied Soft Computing'
paperurl: 'https://www.sciencedirect.com/science/article/pii/S1568494626002929'
citation: 'Yilmaz, M. U., & Alakus, T. B. (2026). Neural circuit policy and hybrid deep learning models for enhanced meteorological drought forecasting performance. Applied Soft Computing, 193, 114844.'
---
